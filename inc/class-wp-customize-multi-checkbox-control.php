 ...
 */
class MCStarter_Customize_Multi_Checkbox_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'mcstarter-customize-controls', get_template_directory_uri() . '/js/multi-checkbox-customize-controls.js' );
	}
